...
import multicard.pages.object.model.MyCatagoryPage;
...
public class MctTestHelper {
	...
	private MyCatagoryPage myCatagory;
	...
	public MyCatagoryPage getMyCatagory() {



		if (myCatagory == null) {

			myCatagory = new MyCatagoryPage(getDriver());
